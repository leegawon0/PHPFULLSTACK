...
function clock() {
    ...
    span1.innerHTML = present.toLocaleTimeString();
}
...
stopbtn.addEventListener( 'click', () => myInterval = clearInterval(myInterval) );

// 재시작 버튼
const restartbtn = document.getElementById('restartbtn');
restartbtn.addEventListener( 'click', () => { if(!myInterval) { clock(); myInterval = setInterval(clock, 1000); } });